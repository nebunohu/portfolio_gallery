  ...
  app.post('/public/projects/art', async (req, res) => {
    try {
      ...
      if (req.files.hasOwnProperty('cover')) {
        ...
        fs.readFile(path.resolve(__dirname, './public/art/data.json'), 'utf8', async (error, data) => {
          ...
          fs.writeFile(path.resolve(__dirname, './public/art/data.json'), jsonDataFile, (error) => {
